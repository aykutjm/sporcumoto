-- Supabase Schema - Firebase %100 Uyumlu (Case-Sensitive)
-- Tüm column adları tırnak içinde - Firebase ile birebir aynı
...
-- 4. Members Table (Türkçe field adları - quoted)
